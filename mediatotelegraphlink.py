...
🌐لأنشاء الروابط في **المجموعات**,اضفني لمجموعه خارقه اي عامه وارسل الامر <code>/hms</code> ردا علي ملف وسائط صالح.
...
print("بوت اشتغل لو شي وقف معك كلمني @Almortagel_12")
teletips.run()
